...
/**************************************************
 * CALL
 * In JavaScript, a 'call' typically refers to the use of the call() method or the apply() method on a function object. These methods are used to invoke a function while explicitly specifying the value of the this keyword within the function and passing arguments to the function.
 **************************************************/
